...
/**
 * Abstract class that construct a new interval thread that will run on the given interval with the given name.<br>
 * 
 * @author Frederic SACHOT
 */
public abstract class IntervalDBWork implements Runnable {
	/**
	 * Log4J logger of the class.
	 */
	private static final Logger logger = Logger.getLogger(IntervalDBWork.class);
	/**
	...
	protected Connection getConnection(){
		...
		try {
			...
			logger.fatal("ERROR creating connection",e);
		}
		return cnDataBase;
	}
}
