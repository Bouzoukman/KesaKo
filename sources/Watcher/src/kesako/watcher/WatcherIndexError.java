...
public class WatcherIndexError {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(WatcherIndexError.class);
	/**
	...
	public static void main(String[] args) {
		DOMConfigurator.configure("log4j_watcherIndexError.xml");
